...
abstract class AppLocalizations {
  ...
  /// No description provided for @hardwareDiagnosticsHttpProxy.
  ///
  /// In en, this message translates to:
  /// **'HTTP Proxy'**
  String get hardwareDiagnosticsHttpProxy;
  ...
  /// No description provided for @httpProxySettingsDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @httpProxySettingsEnableLabel.
  ///
  /// In en, this message translates to:
  /// **'Use HTTP proxy'**
  String get httpProxySettingsEnableLabel;

  /// No description provided for @httpProxySettingsHostLabel.
  ///
  /// In en, this message translates to:
  /// **'Proxy host or IP'**
  String get httpProxySettingsHostLabel;

  /// No description provided for @httpProxySettingsHostHint.
  ///
  /// In en, this message translates to:
  /// **'e.g. 192.168.1.10'**
  String get httpProxySettingsHostHint;

  /// No description provided for @httpProxySettingsHostHelper.
  ///
  /// In en, this message translates to:
  /// **'Enter a host name or IP without a scheme, path, or port.'**
  String get httpProxySettingsHostHelper;

  /// No description provided for @httpProxySettingsHostRequired.
  ///
  /// In en, this message translates to:
  /// **'Enter a proxy host or IP.'**
  String get httpProxySettingsHostRequired;

  /// No description provided for @httpProxySettingsHostInvalid.
  ///
  /// In en, this message translates to:
  /// **'Enter a valid host name, IPv4 address, or IPv6 address.'**
  String get httpProxySettingsHostInvalid;

  /// No description provided for @httpProxySettingsPortLabel.
  ///
  /// In en, this message translates to:
  /// **'Proxy port'**
  String get httpProxySettingsPortLabel;

  /// No description provided for @httpProxySettingsPortHint.
  ///
  /// In en, this message translates to:
  /// **'e.g. 9090'**
  String get httpProxySettingsPortHint;

  /// No description provided for @httpProxySettingsPortRequired.
  ///
  /// In en, this message translates to:
  /// **'Enter a proxy port.'**
  String get httpProxySettingsPortRequired;

  /// No description provided for @httpProxySettingsPortInvalid.
  ///
  /// In en, this message translates to:
  /// **'Enter a port from 1 to 65535.'**
  String get httpProxySettingsPortInvalid;

  /// No description provided for @httpProxySettingsWarning.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @httpProxySettingsCertificateHint.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @httpProxySettingsSaveAction.
  ///
  /// In en, this message translates to:
  /// **'Save'**
  String get httpProxySettingsSaveAction;

  /// No description provided for @httpProxySettingsSaved.
  ///
  /// In en, this message translates to:
  /// **'HTTP proxy settings saved.'**
  String get httpProxySettingsSaved;

  /// No description provided for @httpProxySettingsSaveFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to save HTTP proxy settings. Please try again.'**
  String get httpProxySettingsSaveFailed;

  /// No description provided for @httpProxySettingsStatusEnabled.
  ///
  /// In en, this message translates to:
  /// **'Enabled'**
  String get httpProxySettingsStatusEnabled;

  /// No description provided for @httpProxySettingsStatusDisabled.
  ///
  /// In en, this message translates to:
  /// **'Disabled'**
  String get httpProxySettingsStatusDisabled;
