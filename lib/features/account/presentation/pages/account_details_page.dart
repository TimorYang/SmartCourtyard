                    ...
                    _AccountDetailsRows(
                      rows: [
                        ...
                        _AccountDetailsRowData(
                          ...
                          showChevron: true,
                          onTap: () => _showAccountPasswordSheet(context),
                        ),
                        _AccountDetailsRowData(
...
Future<void> _showAccountRenameSheet(
  ...
  return showModalBottomSheet<void>(
    ...
    barrierColor: AppColors.overlaySoft,
    backgroundColor: Colors.transparent,
    builder: (context) => _RenameBottomSheet(initialName: initialName),
  );
}

Future<void> _showAccountPasswordSheet(BuildContext context) {
  return showModalBottomSheet<void>(
    context: context,
    isDismissible: true,
    enableDrag: true,
    ...
    barrierColor: AppColors.overlaySoft,
    backgroundColor: Colors.transparent,
    builder: (context) => const _PasswordBottomSheet(),
  );
}
...
class _RenameBottomSheet extends StatefulWidget {
  const _RenameBottomSheet({required this.initialName});
...
class _RenameBottomSheetState extends State<_RenameBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return _AccountBottomSheetFrame(
      child: Padding(
        padding: const EdgeInsets.fromLTRB(32, 46, 32, 38),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text(
