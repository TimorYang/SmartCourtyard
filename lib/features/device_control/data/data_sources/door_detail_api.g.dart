...
class _DoorDetailApi implements DoorDetailApi {
  _DoorDetailApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ApiEnvelopeDto<DoorDetailResponseDto>> fetchDoorDetail(
    ...
    late ApiEnvelopeDto<DoorDetailResponseDto> _value;
    try {
      _value = ApiEnvelopeDto<DoorDetailResponseDto>.fromJson(
        _result.data!,
        (json) => DoorDetailResponseDto.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
