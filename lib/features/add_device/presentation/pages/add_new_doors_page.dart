...
class AddNewDoorsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final doorTypes = [
      _DoorTypeOption(
        label: l10n.addNewDoorsGarageDoor,
        assetPath: AddNewDoorsAssetPaths.garageDoor,
        fallbackIcon: Icons.garage_outlined,
      ),
      _DoorTypeOption(
        label: l10n.addNewDoorsRollerDoor,
        assetPath: AddNewDoorsAssetPaths.rollerDoor,
        fallbackIcon: Icons.window_outlined,
      ),
      _DoorTypeOption(
        label: l10n.addNewDoorsIndustrialDoor,
        assetPath: AddNewDoorsAssetPaths.industrialDoor,
        fallbackIcon: Icons.warehouse_outlined,
      ),
      _DoorTypeOption(
        label: l10n.addNewDoorsSwingGate,
        assetPath: AddNewDoorsAssetPaths.swingGate,
        fallbackIcon: Icons.door_front_door_outlined,
      ),
      _DoorTypeOption(
        label: l10n.addNewDoorsSlidingGate,
        assetPath: AddNewDoorsAssetPaths.slidingGate,
          ...
          for (final option in doorTypes) ...[
            _DoorTypeCard(
              ...
              onPressed: () => showAddDoorNameDialog(
                context,
                onConfirmed: () => context.push(AddDevicePage.routePath),
              ),
            ),
