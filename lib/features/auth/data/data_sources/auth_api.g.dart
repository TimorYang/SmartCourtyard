...
class _AuthApi implements AuthApi {
  ...
  Future<ApiEnvelopeDto<FacebookLoginNonceResponseDto>> fetchFacebookLoginNonce(
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: 'app/auth/facebook/nonce',
    )..data = _data;
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiEnvelopeDto<FacebookLoginNonceResponseDto> _value;
    try {
      _value = ApiEnvelopeDto<FacebookLoginNonceResponseDto>.fromJson(
        _result.data!,
        (json) => FacebookLoginNonceResponseDto.fromJson(
