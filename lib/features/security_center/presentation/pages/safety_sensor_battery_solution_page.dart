...
class _BatterySolutionSummaryCard extends StatelessWidget {
  const _BatterySolutionSummaryCard({
    required this.overviewImageAsset,
    required this.batteryImageAsset,
  });
              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _BatterySpecificationLine(
                        label: l10n.safetySensorBatteryModelLabel,
                        value: 'ER14505',
                      ),
                      const SizedBox(height: 12),
                      _BatterySpecificationLine(
                        label: l10n.safetySensorRatedVoltageLabel,
                        value: '3.6V',
                      ),
                      const SizedBox(height: 12),
                      Text(
...
SafetySensor? _findSensor(SafetySensorsEvaluation evaluation, String sensorId) {
  for (final group in [
    evaluation.wiredSensorGroup,
    evaluation.wirelessSensorGroup,
  ]) {
