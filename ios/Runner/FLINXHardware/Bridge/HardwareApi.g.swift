...
enum SafetyAccessoryPairingActionDto: Int {
  case start = 0
  case cancel = 1
}

enum SafetyAccessoryPairingStatusDto: Int {
  case success = 0
  case failure = 1
  case timeout = 2
  case unknown = 3
...
struct PermissionSnapshotDto: Hashable {
  var bluetoothStatus: PermissionStatusDto
  var cameraStatus: PermissionStatusDto
  var locationStatus: PermissionStatusDto
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PermissionSnapshotDto? {
    let bluetoothStatus = pigeonVar_list[0] as! PermissionStatusDto
    let cameraStatus = pigeonVar_list[1] as! PermissionStatusDto
    let locationStatus = pigeonVar_list[2] as! PermissionStatusDto
  ...
  func hash(into hasher: inout Hasher) {
    ...
    deepHashHardwareApi(value: bluetoothStatus, hasher: &hasher)
    deepHashHardwareApi(value: cameraStatus, hasher: &hasher)
    deepHashHardwareApi(value: locationStatus, hasher: &hasher)
...
/// Generated class from Pigeon that represents data sent in messages.
struct ConnectedBleDeviceDto: Hashable {
  var deviceId: String
  var name: String? = nil
  var state: BleConnectionStateDto
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> ConnectedBleDeviceDto? {
  ...
  static func == (lhs: ConnectedBleDeviceDto, rhs: ConnectedBleDeviceDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHardwareApi(lhs.deviceId, rhs.deviceId) && deepEqualsHardwareApi(lhs.name, rhs.name) && deepEqualsHardwareApi(lhs.state, rhs.state)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("ConnectedBleDeviceDto")
    deepHashHardwareApi(value: deviceId, hasher: &hasher)
    deepHashHardwareApi(value: name, hasher: &hasher)
    deepHashHardwareApi(value: state, hasher: &hasher)
  }
...
/// Generated class from Pigeon that represents data sent in messages.
struct SafetyAccessoryPairingResultDto: Hashable {
  var requestId: String
  var deviceId: String
  var status: SafetyAccessoryPairingStatusDto
  var reasonCode: Int64? = nil
  var nativeCode: String? = nil
  var domainCode: String? = nil
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> SafetyAccessoryPairingResultDto? {
    let requestId = pigeonVar_list[0] as! String
    let deviceId = pigeonVar_list[1] as! String
    let status = pigeonVar_list[2] as! SafetyAccessoryPairingStatusDto
    let reasonCode: Int64? = nilOrValue(pigeonVar_list[3])
    let nativeCode: String? = nilOrValue(pigeonVar_list[4])
    let domainCode: String? = nilOrValue(pigeonVar_list[5])
  ...
  static func == (lhs: SafetyAccessoryPairingResultDto, rhs: SafetyAccessoryPairingResultDto) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsHardwareApi(lhs.requestId, rhs.requestId) && deepEqualsHardwareApi(lhs.deviceId, rhs.deviceId) && deepEqualsHardwareApi(lhs.status, rhs.status) && deepEqualsHardwareApi(lhs.reasonCode, rhs.reasonCode) && deepEqualsHardwareApi(lhs.nativeCode, rhs.nativeCode) && deepEqualsHardwareApi(lhs.domainCode, rhs.domainCode)
  ...
  func hash(into hasher: inout Hasher) {
    hasher.combine("SafetyAccessoryPairingResultDto")
    deepHashHardwareApi(value: requestId, hasher: &hasher)
    deepHashHardwareApi(value: deviceId, hasher: &hasher)
    deepHashHardwareApi(value: status, hasher: &hasher)
    deepHashHardwareApi(value: reasonCode, hasher: &hasher)
...
private class HardwareApiPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 134:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return SafetyAccessoryPairingActionDto(rawValue: enumResultAsInt)
      }
      return nil
    case 135:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return SafetyAccessoryPairingStatusDto(rawValue: enumResultAsInt)
      }
      return nil
    case 136:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
    ...
    case 145:
      return ConnectedBleDeviceDto.fromList(self.readValue() as! [Any?])
    case 146:
...
private class HardwareApiPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? PermissionKindDto {
      ...
      super.writeByte(133)
      super.writeValue(value.rawValue)
    } else if let value = value as? SafetyAccessoryPairingActionDto {
      super.writeByte(134)
      super.writeValue(value.rawValue)
    } else if let value = value as? SafetyAccessoryPairingStatusDto {
      super.writeByte(135)
      super.writeValue(value.rawValue)
      ...
      super.writeByte(144)
      super.writeValue(value.toList())
    } else if let value = value as? ConnectedBleDeviceDto {
      super.writeByte(145)
      super.writeValue(value.toList())
...
protocol HardwareHostApi {
  ...
  func getConnectedBleDevices(requestId: String, completion: @escaping (Result<[ConnectedBleDeviceDto], Error>) -> Void)
  func disconnectAllManagedBleDevices(requestId: String, completion: @escaping (Result<[BleConnectionEventDto], Error>) -> Void)
...
class HardwareHostApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: HardwareHostApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      getPermissionSnapshotChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let requestIdArg = args[0] as! String
        do {
          let result = try api.getPermissionSnapshot(requestId: requestIdArg)
    ...
    if let api = api {
      requestPermissionsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let requestIdArg = args[0] as! String
        let permissionsArg = args[1] as! [PermissionKindDto]
        do {
          let result = try api.requestPermissions(requestId: requestIdArg, permissions: permissionsArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      openAppSettingsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let requestIdArg = args[0] as! String
        do {
          try api.openAppSettings(requestId: requestIdArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let getConnectedBleDevicesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flinx.HardwareHostApi.getConnectedBleDevices\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getConnectedBleDevicesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let requestIdArg = args[0] as! String
        api.getConnectedBleDevices(requestId: requestIdArg) { result in
          switch result {
      ...
      getConnectedBleDevicesChannel.setMessageHandler(nil)
    }
    let disconnectAllManagedBleDevicesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flinx.HardwareHostApi.disconnectAllManagedBleDevices\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      disconnectAllManagedBleDevicesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let requestIdArg = args[0] as! String
        api.disconnectAllManagedBleDevices(requestId: requestIdArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      disconnectAllManagedBleDevicesChannel.setMessageHandler(nil)
    }
    ...
    let pairSafetyAccessoryChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flinx.HardwareHostApi.pairSafetyAccessory\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pairSafetyAccessoryChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let requestIdArg = args[0] as! String
        let deviceIdArg = args[1] as! String
        let actionArg = args[2] as! SafetyAccessoryPairingActionDto
        api.pairSafetyAccessory(requestId: requestIdArg, deviceId: deviceIdArg, action: actionArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
